 ...
 * @author cblsa
 */
public class WeekendPrimeTimeDiscountDecoratorTest {
    ...
    public void testGetParkingChargeWithWeekendPrimeTimeDiscount() {
        ...
        lot.setStrategy("WeekendPrimeTimeDiscount");
        ...
        Instant timeIn = Instant.parse("2023-09-23T08:00:00Z");
        ...
        // Expected charge: $75 Flat rate ($15) + weekend ($20) + day ($20)
        Money expectedCharge = Money.of(55.00);
